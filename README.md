...
if game.CoreGui:FindFirstChild("GoosT HuB Premium Script | King Legacy") then
    game.CoreGui:FindFirstChild("GoosT HuB Premium Script | King Legacy"):Destroy()
end
...
function Blacklib:Window()
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("G") wait(.2) titlefunc:Refresh("Go") wait(.2) titlefunc:Refresh("Goo") wait(.2) titlefunc:Refresh("Goos") wait(.2) titlefunc:Refresh("GoosT") wait(.2) titlefunc:Refresh("GoosT H") wait(.2) titlefunc:Refresh("GoosT Hu") wait(.2) titlefunc:Refresh("GoosT HuB") wait(.2) titlefunc:Refresh("GoosT Hub | King Legacy") wait(.9) titlefunc:Refresh("GoosT Hub") wait(.2) titlefunc:Refresh("GoosT Hu") wait(.2) titlefunc:Refresh("GoosT H") wait(.2) titlefunc:Refresh("GoosT") wait(.2) titlefunc:Refresh("Goos") wait(.2) titlefunc:Refresh("Goo") wait(.2) titlefunc:Refresh("Go") wait(.2) titlefunc:Refresh("G") wait(.2) titlefunc:Refresh("") wait(.2) wait(.3)
        end
    end)
    -- End Windows --
